...
public class Surfboard {
    ...
    public static String sensors() throws IOException {
        ...
        String sending = "sensors";
        System.out.println("Sending discovery to surfboard...");
        outStream.write(sending.getBytes());
        byte response[] = new byte[1024];
        int counter = 0;
        try {
            System.out.println("Waiting responde RXTX...");
            for (int x = 0; x < 10; x++) {
                Thread.sleep(40);
