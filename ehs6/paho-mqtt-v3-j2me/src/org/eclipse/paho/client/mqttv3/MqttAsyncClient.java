...
import com.cwm.net.MqttMicroNetworkFactory;
import com.cwm.net.SSLMicroNetworkModule;
import com.cwm.net.TCPMicroNetworkModule;
...
public class MqttAsyncClient implements IMqttAsyncClient { // DestinationProvider {
	...
	protected NetworkModule createNetworkModule(String address, MqttConnectOptions options) throws MqttException, MqttSecurityException {
		...
		MqttMicroNetworkFactory meNetFactory = new MqttMicroNetworkFactory();
		netModule = meNetFactory.createNetworkModule(address, options, clientId);
//		String shortAddress;
//		String host;
//		int port;
//		MqttMicroNetworkFactory factory = options.getSocketFactory();
...
//			if (factory == null) {
//				factory = MqttMicroNetworkFactory.getDefault();
//				options.setSocketFactory(factory);
//			}
//			else if (factory instanceof SSLSocketFactory) {
//				throw ExceptionHelper.createMqttException(MqttException.REASON_CODE_SOCKET_FACTORY_MISMATCH);
//			}
//			netModule = new TCPMicroNetworkModule(factory, host, port, clientId);
//			((TCPMicroNetworkModule)netModule).setConnectTimeout(options.getConnectionTimeout());
//			break;
//		case URI_TYPE_SSL:
//			shortAddress = address.substring(6);
//			host = getHostName(shortAddress);
...
//			netModule = new SSLMicroNetworkModule((SSLSocketFactory) factory, host, port, clientId);
//			((SSLMicroNetworkModule)netModule).setSSLhandshakeTimeout(options.getConnectionTimeout());
//			// Ciphers suites need to be set, if they are available
//			if (factoryFactory != null) {
//				String[] enabledCiphers = factoryFactory.getEnabledCipherSuites(null);
//				if (enabledCiphers != null) {
//					((SSLMicroNetworkModule) netModule).setEnabledCiphers(enabledCiphers);
//				}
//			}
//			break;
//		case URI_TYPE_LOCAL:
