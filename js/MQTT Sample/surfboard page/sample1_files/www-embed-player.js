...
function Fa(a,b){for(var c=0,d=ra(String(a)).split("."),e=ra(String(b)).split("."),f=Math.max(d.length,e.length),h=0;0==c&&h<f;h++){var k=d[h]||"",m=e[h]||"",n=RegExp("(\\d*)(\\D*)","g"),H=RegExp("(\\d*)(\\D*)","g");do{var R=n.exec(k)||["","",""],ha=H.exec(m)||["","",""];if(0==R[0].length&&0==ha[0].length)break;c=Ga(0==R[1].length?0:parseInt(R[1],10),0==ha[1].length?0:parseInt(ha[1],10))||Ga(0==R[2].length,0==ha[2].length)||Ga(R[2],ha[2])}while(0==c)}return c}
...
return d}
function Td(a){if(ia(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);c?a[b]=Ec(sb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax"),a[b]):Td(a[b])}}
...
je.prototype.isElement=function(a){return ia(a)&&1==a.nodeType};
...
x(Yg,O);var Zg=new P("timing-sent",Yg);var $g={ad_at:"ad_type",cpn:"client_playback_nonce",csn:"client_screen_nonce",yt_lt:"load_type",yt_ad:"is_monetized",yt_ad_pr:"preroll_allowed",yt_red:"is_red_subscriber",yt_vis:"is_visible"},ah=["is_monetized","preroll_allowed","is_red_subscriber","is_visible"],bh=v(Xg.clearResourceTimings||Xg.webkitClearResourceTimings||Xg.mozClearResourceTimings||Xg.msClearResourceTimings||Xg.oClearResourceTimings||t,Xg),ch=Xg.mark?function(a){Xg.mark(a)}:t;
function dh(a){ch(a);eh()[a]=fc();var b=fh();"gel"in b||(b.gel={});b.gel[a]=void 0;$f("csi_on_gel")?(b=gh(),"_start"==a?ig("latencyActionBaselined",{clientActionNonce:b},void 0):ig("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0),a=!0):a=!1;if(!a&&(b=F("TIMING_ACTION",void 0),a=eh(),r("yt.timing.ready_")&&b&&a._start&&hh())){var b=!0,c=F("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}if(b)if(d=eh(),a=fh().span,e=fh().info,b=r("yt.timing.reportbuilder_")){if(b=
b(d,a,e,void 0))ih(b),jh()}else{var f=F("CSI_SERVICE_NAME","youtube"),b={v:2,s:f,action:F("TIMING_ACTION",void 0)},c=e.srt;delete e.srt;void 0===d.srt&&(c||0===c||(c=Xg.timing||{},c=Math.max(0,c.responseStart-c.navigationStart),isNaN(c)&&e.pt&&(c=e.pt)),c||0===c)&&(e.srt=Math.round(c));if(e.h5jse){var h=window.location.protocol+r("ytplayer.config.assets.js");(h=Xg.getEntriesByName?Xg.getEntriesByName(h)[0]:null)?e.h5jse=Math.round(e.h5jse-h.responseEnd):delete e.h5jse}d.aft=hh();var h=d._start,k=
eh(),m=k.pbr,n=k.vc,k=k.pbs;m&&n&&k&&m<n&&n<k&&1==fh().info.yt_vis&&"youtube"==f&&(m=fh().info.yt_lt="hot_bg",$f("csi_on_gel")&&("yt_lt"in $g?(f={},n=$g.yt_lt,n in ah&&(m=!!m),f[n]=m,m=gh(),f.clientActionNonce=m,ig("latencyActionInfo",f)):dc(Error("Unknown label yt_lt logged with GEL CSI."))),f=d.vc,m=d.pbs,delete d.aft,e.aft=Math.round(m-f));for(var H in e)"_"!=H.charAt(0)&&(b[H]=e[H]);d.ps=fc();H={};var e=[],R;for(R in d)"_"!=R.charAt(0)&&(f=Math.round(d[R]-h),$f("enable_negative_ticks")||(f=Math.max(f,
0)),H[R]=f,e.push(R+"."+f));b.rt=e.join(",");R=b;var d=[],ha;for(ha in a)"_"!=ha.charAt(0)&&d.push(ha+"."+Math.round(a[ha]));R.it=d.join(",");(ha=r("ytdebug.logTiming"))&&ha(b,H,a);jh();F("EXP_DEFER_CSI_PING")?(kh(),q("yt.timing.deferredPingArgs_",b,void 0),ha=G(kh,0),q("yt.timing.deferredPingTimer_",ha,void 0)):ih(b);Q(Zg,new Yg(H.aft+(c||0)))}}}
function jh(){lh();bh();q("yt.timing.pingSent_",!1,void 0)}
...
Mg(a);q("yt.timing.pingSent_",!0,void 0)}
function kh(a){if(F("EXP_DEFER_CSI_PING")){var b=r("yt.timing.deferredPingArgs_");b&&(a&&(b.yt_fss=a),ih(b))}}
function gh(){var a=fh().nonce;if(!a){var b;a:{if(window.crypto&&window.crypto.getRandomValues)try{var c=Array(16),d=new Uint8Array(16);window.crypto.getRandomValues(d);for(a=0;a<c.length;a++)c[a]=d[a];b=c;break a}catch(e){}b=Array(16);for(c=0;16>c;c++){d=w();for(a=0;a<d%23;a++)b[c]=Math.random();b[c]=Math.floor(256*Math.random())}if(Wg)for(c=1,d=0;d<Wg.length;d++)b[c%16]=b[c%16]^b[(c-1)%16]/4^Wg.charCodeAt(d),c++}c=[];for(d=0;d<b.length;d++)c.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(b[d]&
63));a=c.join("");fh().nonce=a}return a}
function eh(){return fh().tick}
function fh(){return r("ytcsi.data_")||lh()}
function lh(){var a={tick:{},span:{},info:{}};q("ytcsi.data_",a,void 0);return a}
;var mh={"api.invalidparam":2,auth:150,"drm.auth":150,heartbeat:150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"html5.unsupportedlive":5,"drm.unavailable":5};function nh(a,b){C.call(this);this.l=this.i=a;this.aa=b;this.C=!1;this.f={};this.pa=this.W=null;this.ba=new E;Wb(this,oa(D,this.ba));this.h={};this.j=this.Fa=this.g=this.wb=this.b=null;this.ia=!1;this.D=this.o=this.K=this.L=null;this.$a={};this.Uc=["onReady"];this.ja=new Xf(this);Wb(this,oa(D,this.ja));this.xb=null;this.Wb=NaN;this.ka={};oh(this);this.ma("onDetailedError",v(this.Dd,this));this.ma("onTabOrderChange",v(this.Yc,this));this.ma("onTabAnnounce",v(this.Xb,this));this.ma("WATCH_LATER_VIDEO_ADDED",
...
function qh(a,b){a.wb=b;a.b=b.clone();a.g=a.b.attrs.id||a.g;"video-player"==a.g&&(a.g=a.aa,a.b.attrs.id=a.aa);a.l.id==a.g&&(a.g+="-player",a.b.attrs.id=a.g);a.b.args.enablejsapi="1";a.b.args.playerapiid=a.aa;a.Fa||(a.Fa=th(a,a.b.args.jsapicallback||"onYouTubePlayerReady"));a.b.args.jsapicallback=null;var c=a.b.attrs.width;c&&(a.l.style.width=ef(Number(c)||c,!0));if(c=a.b.attrs.height)a.l.style.height=ef(Number(c)||c,!0)}
...
function rh(a,b){if(!a.isDisposed()){if(!b){var c;if(!(c=!a.b.html5&&uh(a))){if(!p(a.b.disable.html5)){var d;c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(2.2==Pf)d=!0;else{a:{var e=c;c=r("yt.player.utils.videoElement_");c||(c=document.createElement("video"),q("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?Vf:Wf,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(h){d="html5.missingapi"}}d=!d}d&&(d=xh(a)||a.b.assets.js);
...
g.ne=function(){if(!this.ia){var a=xh(this);a&&"html5"==yh(this)?(this.j="html5",this.C||this.Ka()):(zh(this),this.j="html5",a&&this.K?(this.i.appendChild(this.K),this.Ka()):(this.b.loaded=!0,this.L=v(function(){var a=this.i,c=this.b.clone();r("yt.player.Application.create")(a,c);this.Ka()},this),this.ia=!0,a?this.L():(sc(this.b.assets.js,this.L),Kf(this.b.assets.css))))}};
g.me=function(){var a=this.b.clone();if(!this.o){var b=wh(this);b&&(this.o=document.createElement("span"),this.o.tabIndex=0,Yf(this.ja,this.o,"focus",this.jc),this.D=document.createElement("span"),this.D.tabIndex=0,Yf(this.ja,this.D,"focus",this.jc),b.parentNode&&b.parentNode.insertBefore(this.o,b),b.parentNode&&b.parentNode.insertBefore(this.D,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==yh(this))this.j="flash",this.C||Gf(a,!1,v(this.Ka,this));
else{zh(this);this.j="flash";this.b.loaded=!0;b=this.i;b=u(b)?me(b):b;a=Ye(a);if(window!=window.top){var c=null;document.referrer&&(c=document.referrer.substring(0,128));a.args.framer=c}c=Bf.getInstance();Cf(c,a.minVersion)?(c=Hf(a,c),Ff(b,c,a)):Jf(b,a,c);this.Ka()}};
g.jc=function(){wh(this).focus()};
function wh(a){var b=le(a.g);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.g));return b}
g.Ka=function(){if(!this.isDisposed()){var a=wh(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.ia=!1,a.isNotServable&&a.isNotServable(this.b.args.video_id))vh(this);else{oh(this);this.C=!0;a=wh(this);a.addEventListener&&(this.W=Ah(this,a,"addEventListener"));a.removeEventListener&&(this.pa=Ah(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.f[d]||(this.f[d]=Ah(this,a,d))}for(var e in this.h)this.W(e,
this.h[e]);sh(this);this.Fa&&this.Fa(this.f);this.ba.u("onReady",this.f)}else this.Wb=G(v(this.Ka,this),50)}};
function Ah(a,b,c){var d=b[c];return function(){try{return a.xb=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.xb=e,dc(e,"WARNING"))}}}
...
function zh(a){dh("dcp");a.cancel();oh(a);a.j=null;a.b&&(a.b.loaded=!1);var b=wh(a);"html5"==yh(a)?a.K=b:b&&b.destroy&&b.destroy();re(a.i);Zf(a.ja);a.o=null;a.D=null}
g.cancel=function(){this.L&&zc(this.b.assets.js,this.L);I(this.Wb);this.ia=!1};
g.w=function(){zh(this);if(this.K&&this.b)try{this.K.destroy()}catch(b){dc(b)}this.$a=null;for(var a in this.h)l[this.h[a]]=null;this.wb=this.b=this.f=null;delete this.i;delete this.l;nh.A.w.call(this)};var Ch={},Dh="player_uid_"+(1E9*Math.random()>>>0);function Eh(a,b){a=u(a)?me(a):a;b=Ye(b);var c=Dh+"_"+ja(a),d=Ch[c];if(d)return d.Sb(b),d.f;d=new nh(a,c);Ch[c]=d;J("player-added",d.f);Wb(d,oa(Fh,d));G(function(){d.Sb(b)},0);
return d.f}
function Fh(a){Ch[a.aa]=null}
function Gh(a){a=le(a);if(!a)return null;var b=Dh+"_"+ja(a),c=Ch[b];c||(c=new nh(a,b),Ch[b]=c);return c.f}
;var Hh=r("yt.abuse.botguardInitialized")||Cc;q("yt.abuse.botguardInitialized",Hh,void 0);var Ih=r("yt.abuse.invokeBotguard")||Dc;q("yt.abuse.invokeBotguard",Ih,void 0);var Jh=r("yt.abuse.dclkstatus.checkDclkStatus")||$d;q("yt.abuse.dclkstatus.checkDclkStatus",Jh,void 0);var Kh=r("yt.player.exports.navigate")||Te;q("yt.player.exports.navigate",Kh,void 0);var Lh=r("yt.player.embed")||Eh;q("yt.player.embed",Lh,void 0);var Mh=r("yt.player.getPlayerByElement")||Gh;q("yt.player.getPlayerByElement",Mh,void 0);
var Nh=r("yt.util.activity.init")||Ke;q("yt.util.activity.init",Nh,void 0);var Oh=r("yt.util.activity.getTimeSinceActive")||Me;q("yt.util.activity.getTimeSinceActive",Oh,void 0);var Ph=r("yt.util.activity.setTimestamp")||Le;q("yt.util.activity.setTimestamp",Ph,void 0);function Qh(a){O.call(this,1,arguments);this.b=a}
...
Rh),hi=new P("subscription-external-unsubscribe",Vh),ii=new P("subscription-enable-ypc",Rh),ji=new P("subscription-disable-ypc",Rh);function ki(a,b){var c=document.location.protocol+"//"+document.domain+"/post_login";b&&(c=Ed(c,"mode",b));c=Ed("/signin?context=popup","next",c);c=Ed(c,"feature","sub_button");if(c=window.open(c,"loginPopup","width=375,height=440,resizable=yes,scrollbars=yes",!0)){var d=mc("LOGGED_IN",function(b){oc(F("LOGGED_IN_PUBSUB_KEY",void 0));ac("LOGGED_IN",!0);a(b)});
...
function qi(a){var b="mouseover"==a.type&&"mouseenter"in ni||"mouseout"==a.type&&"mouseleave"in ni,c=a.type in ni||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=ni[b],d;for(d in c.$){var e=pi(b,d,a.target);e&&!Be(a.relatedTarget,function(a){return a==e},!0)&&c.u(d,e,b,a)}}if(b=ni[a.type])for(d in b.$)(e=pi(a.type,d,a.target))&&b.u(d,e,a.type,a)}}
...
ri.prototype.unregister=function(){oc(this.lb);this.lb.length=0;Vg(this.h);this.h.length=0};
ri.prototype.init=t;ri.prototype.dispose=t;function si(a,b,c){a.h.push(Ug(b,c,a))}
...
function vi(a,b){Eb(a,"tooltip-text",b)}
...
g.ib=function(a){if(!(this.b&&1E3>w()-this.b)){var b=parseInt(B(a,"tooltip-hide-timer"),10);b&&(Gb(a,"tooltip-hide-timer"),I(b));var b=v(function(){xi(this,a);Gb(a,"tooltip-show-timer")},this),c=parseInt(B(a,"tooltip-show-delay"),10)||0,b=G(b,c);
Eb(a,"tooltip-show-timer",b.toString());a.title&&(vi(a,yi(a)),a.title="");b=ja(a).toString();this.f[b]=a}};
g.Ba=function(a){var b=parseInt(B(a,"tooltip-show-timer"),10);b&&(I(b),Gb(a,"tooltip-show-timer"));b=v(function(){if(a){var b=le(zi(this,a));b&&(Ai(b),b&&b.parentNode&&b.parentNode.removeChild(b),Gb(a,"content-id"));(b=le(zi(this,a,"arialabel")))&&b.parentNode&&b.parentNode.removeChild(b)}Gb(a,"tooltip-hide-timer")},this);
...
function Bi(a,b){vi(a,b);var c=B(a,"content-id");(c=le(c))&&ue(c,b)}
function yi(a){return B(a,"tooltip-text")||a.title}
function xi(a,b){if(b){var c=yi(b);if(c){var d=le(zi(a,b));if(!d){d=document.createElement("div");d.id=zi(a,b);d.className=S(a,"tip");var e=document.createElement("div");e.className=S(a,"tip-body");var f=document.createElement("div");f.className=S(a,"tip-arrow");var h=document.createElement("div");h.setAttribute("aria-hidden","true");h.className=S(a,"tip-content");var k=Ci(a,b),m=zi(a,b,"content");h.id=m;Eb(b,"content-id",m);e.appendChild(h);k&&d.appendChild(k);d.appendChild(e);d.appendChild(f);var m=
xe(b),n=zi(a,b,"arialabel"),f=document.createElement("div");ce(f,S(a,"arialabel"));f.id=n;"rtl"==document.body.getAttribute("dir")?ue(f,c+" "+m):ue(f,m+" "+c);b.setAttribute("aria-labelledby",n);m=mi()||document.body;m.appendChild(f);m.appendChild(d);Bi(b,c);(c=parseInt(B(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",ce(h,S(a,"normal-wrap")));h=be(b,S(a,"reverse"));Di(a,b,d,e,k,h)||Di(a,b,d,e,k,!h);var H=S(a,"tip-visible");G(function(){ce(d,H)},0)}}}}
...
function zi(a,b,c){a=S(a);var d=b.__yt_uid_key;d||(d=Ce(),b.__yt_uid_key=d);b=a+d;c&&(b+="-"+c);return b}
function Ci(a,b){var c=null;cd&&be(b,S(a,"masked"))&&((c=le("yt-uix-tooltip-shared-mask"))?(c.parentNode.removeChild(c),zf(c)):(c=document.createElement("iframe"),c.src='javascript:""',c.id="yt-uix-tooltip-shared-mask",c.className=S(a,"tip-mask")));return c}
function Ai(a){var b=le("yt-uix-tooltip-shared-mask"),c=b&&Be(b,function(b){return b==a},!1,2);
...
g.Cc=function(a,b,c){b?(Eb(a,Fi.Ub,"true"),c&&Eb(a,Fi.Vb,c)):(Gb(a,Fi.Ub),Gb(a,Fi.Vb));Hi(a)};
g.Bc=function(a,b){var c;c=ze(a);ee(c,Ae.Pc,b);a.setAttribute("aria-busy",b?"true":"false");a.disabled=b};
function Hi(a){var b=B(a,Fi.Tc),c=!!B(a,"is-subscribed"),b="-"+b,d=Ae.Nc+b;ee(a,Ae.Mc+b,!c);ee(a,d,c);B(a,Fi.Rc)&&!B(a,Fi.Qc)&&(b=S(wi.getInstance()),ee(a,b,!c),a.title=c?"":B(a,Fi.Sc));c?G(function(){ce(a,Ae.Tb)},1E3):de(a,Ae.Tb)}
g.ad=function(a){var b=!!B(a,"ypc-item-type"),c=!!B(a,"ypc-item-id");!B(a,"ypc-enabled")&&b&&c&&(ce(a,"ypc-enabled"),Eb(a,Fi.Vc,"true"))};
g.$c=function(a){B(a,"ypc-enabled")&&(de(a,"ypc-enabled"),Gb(a,"ypc-enabled"))};
function Ii(a,b){var c=ne(S(a));return Ja(c,function(a){return b==B(a,"channel-external-id")},a)}
...
function Gi(a,b){var c=v(function(a){a.discoverable_subscriptions&&ac("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",a.discoverable_subscriptions);this.Ab(b)},a);
ki(c,"subscribe")}
;var Ji=window.yt&&window.yt.uix&&window.yt.uix.widgets_||{};q("yt.uix.widgets_",Ji,void 0);function Ki(a,b){this.source=null;this.h=a||null;this.origin="*";this.o=window.document.location.protocol+"//"+window.document.location.hostname;this.l=b;this.g=this.b=this.f=this.i=null;M(window,"message",v(this.j,this))}
Ki.prototype.j=function(a){var b=this.l||F("POST_MESSAGE_ORIGIN",void 0)||this.o;if("*"!=b&&a.origin!=b)window.console&&window.console.warn("Untrusted origin: "+a.origin);else if(!this.h||a.source==this.h)if(this.source=a.source,this.origin="null"==a.origin?this.origin:a.origin,a=a.data,u(a)){try{a=od(a)}catch(c){return}this.i=a.id;switch(a.event){case "listening":this.b&&(this.b(),this.b=null);break;case "command":this.f&&(this.g&&!z(this.g,a.func)||this.f(a.func,a.args))}}};
Ki.prototype.sendMessage=function(a){this.source&&(a.id=this.i,a=L(a),this.source.postMessage(a,this.origin))};function Li(){}
;function Mi(){}
x(Mi,Li);Mi.prototype.N=function(){var a=0;Ic(this.la(!0),function(){a++});
return a};
Mi.prototype.clear=function(){var a=Jc(this.la(!0)),b=this;y(a,function(a){b.remove(a)})};function Ni(a){this.b=a}
...
Qi.prototype.get=function(a){var b;try{b=this.b.get(a)}catch(c){return}if(null!==b)try{return od(b)}catch(c){throw"Storage: Invalid value was encountered";}};
...
x(Wi,Ui);function Xi(a,b){var c=[];Ic(b,function(a){var b;try{b=Wi.prototype.f.call(this,a,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}p(b)?Vi(b)&&c.push(a):c.push(a)},a);
return c}
...
function hj(a,b,c,d){if(ia(a)&&!da(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}c={index:b,startSeconds:c,suggestedQuality:d};u(a)&&16==a.length?c.list="PL"+a:c.playlist=a;return c}
...
;var Mj={Be:"atp",Ke:"ska",He:"que",Fe:"mus",Je:"sus"};function Nj(a){this.h=this.g="";this.b="/api/lounge";this.f=!0;a=a||document.location.href;var b=Number(a.match(wd)[4]||null)||null||"";b&&(this.h=":"+b);this.g=xd(a)||"";a=nb;0<=a.search("MSIE")&&(a=a.match(/MSIE ([\d.]+)/)[1],0>Fa(a,"10.0")&&(this.f=!1))}
function Oj(a,b,c,d){var e=a.b;if(p(d)?d:a.f)e="https://"+a.g+a.h+a.b;return Fd(e+b,c||{})}
function Pj(a,b,c,d,e){a={format:"JSON",method:"POST",context:a,timeout:5E3,withCredentials:!1,Z:oa(a.l,d,!0),onError:oa(a.i,e),Ca:oa(a.j,e)};c&&(a.J=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return Pd(b,a)}
...
g.wc=function(){this.f=NaN;this.b=Pd(Oj(this.o,"/pairing/get_screen"),{method:"POST",J:{pairing_code:this.j},timeout:5E3,Z:v(this.se,this),onError:v(this.re,this),Ca:v(this.te,this)})};
...
g.te=function(){this.b=null;this.u("pairingFailed",Error("Server not responding"))};function bk(a){this.app=this.name=this.id="";this.type="REMOTE_CONTROL";this.avatar=this.username="";this.capabilities=new Tc;this.experiments=new Tc;this.theme="u";if(a){this.id=a.id||a.name;this.name=a.name;this.app=a.app;this.type=a.type||"REMOTE_CONTROL";this.username=a.user||"";this.avatar=a.userAvatarUri||"";this.theme=a.theme||"u";var b=a.capabilities||"";this.capabilities.clear();Uc(this.capabilities,Ja(b.split(","),oa(ab,Mj)));a=a.experiments||"";this.experiments.clear();Uc(this.experiments,
a.split(","))}}
...
g.ve=function(a,b,c,d){Pd(Oj(this.i,"/pairing/get_screen"),{method:"POST",J:{pairing_code:a},timeout:5E3,Z:v(function(a,d){var h=new Fj(d.screen||{});if(!h.name||Gk(this,h.name)){var k;a:{k=h.name;for(var m=2,n=b(k,m);Gk(this,n);){m++;if(20<m)break a;n=b(k,m)}k=n}h.name=k}c(Ek(this,h))},this),
...
Pd(Oj(a.i,"/pairing/get_lounge_token_batch"),e)}
...
g.Wd=function(a,b){if(!this.isDisposed())if(b){var c=pd(b);if(c){var d=""+c.type,c=c.data||{};this.info("onYoutubeMessage_: "+d+" "+L(c));switch(d){case "mdxSessionStatus":Mk(this,c.screenId);break;default:Kk(this,"Unknown youtube message: "+d)}}else Kk(this,"Unable to parse message.")}else Kk(this,"No data in message.")};
...
function Rk(a){var b={};b.pairingCode=a.G;if(a.i){var c=a.i.currentTime||0;b.v=a.i.videoId;b.t=c}qk()&&(b.env_useStageMdx=1);return Dd(b)}
...
function nl(){kl()?gl()?ol()?($k("Requesting cast selector."),hl.requestSession()):($k("Wait for cast API to be ready to request the session."),jl.push(mc("yt-remote-cast2-api-ready",nl))):dl("requestCastSelector: Cast is not initialized."):dl("requestCastSelector: Cast API is not installed!")}
...
var hl=null;function Zk(){var a;a=0<=nb.search(/\ (CrMo|Chrome|CriOS)\//);return qf||a}
...
function Wl(a,b){var c,d=a.ba;if(d){c=[];for(var e=1;d;d=d.ba)c.push(d),++e}var d=a.pa,e=b,f=e.type||e;if(u(e))e=new ul(e,d);else if(e instanceof ul)e.target=e.target||d;else{var h=e,e=new ul(f,d);mb(e,h)}var h=!0,k;if(c)for(var m=c.length-1;!e.b&&0<=m;m--)k=e.currentTarget=c[m],h=Xl(k,f,!0,e)&&h;e.b||(k=e.currentTarget=d,h=Xl(k,f,!0,e)&&h,e.b||(h=Xl(k,f,!1,e)&&h));if(c)for(m=0;!e.b&&m<c.length;m++)k=e.currentTarget=c[m],h=Xl(k,f,!1,e)&&h}
...
;function Yl(a,b){this.f=new rd(a);this.b=b?pd:od}
Yl.prototype.stringify=function(a){return qd(this.f,a)};
...
var bm=new Lb(function(){return new am},function(a){a.reset()},100);
...
Zl.prototype.then=Zl.prototype.then;Zl.prototype.$goog_Thenable=!0;Zl.prototype.cancel=function(a){0==this.b&&Qb(function(){var b=new fm(a);gm(this,b)},this)};
...
function $l(a,b,c){if(0==a.b){a==c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;var d;a:{var e=c,f=a.C,h=a.V;if(e instanceof Zl)jm(e,cm(f||t,h||null,a)),d=!0;else{var k;if(e)try{k=!!e.$goog_Thenable}catch(n){k=!1}else k=!1;if(k)e.then(f,h,a),d=!0;else{if(ia(e))try{var m=e.then;if(ga(m)){lm(e,m,f,h,a);d=!0;break a}}catch(n){h.call(a,n);d=!0;break a}d=!1}}}d||(a.j=c,a.b=b,a.g=null,km(a),3!=b||c instanceof fm||mm(a,c))}}
function lm(a,b,c,d,e){function f(a){k||(k=!0,d.call(e,a))}
function h(a){k||(k=!0,c.call(e,a))}
var k=!1;try{b.call(a,h,f)}catch(m){f(m)}}
function km(a){a.l||(a.l=!0,Qb(a.o,a))}
...
function im(a,b,c,d){if(3==c&&b.f&&!b.g)for(;a&&a.i;a=a.g)a.i=!1;if(b.b)b.b.g=null,nm(b,c,d);else try{b.g?b.h.call(b.context):nm(b,c,d)}catch(e){om.call(null,e)}Mb(bm,b)}
function nm(a,b,c){2==b?a.h.call(a.context,c):a.f&&a.f.call(a.context,c)}
function mm(a,b){a.i=!0;Qb(function(){a.i&&om.call(null,b)})}
var om=Ib;function fm(a){pa.call(this,a)}
...
function Gm(a,b,c){a.Na=1;a.qa=zg(b.clone());a.Da=c;a.l=!0;Hm(a,null)}
function Im(a,b,c,d,e){a.Na=1;a.qa=zg(b.clone());a.Da=null;a.l=c;e&&(a.Ac=!1);Hm(a,d)}
function Hm(a,b){a.Xa=w();Jm(a);a.ta=a.qa.clone();xg(a.ta,"t",a.j);a.Za=0;a.I=a.b.Bb(a.b.Ya()?b:null);0<a.Ib&&(a.mb=new sm(v(a.Fc,a,a.I),a.Ib));a.h.hb(a.I,"readystatechange",a.Yd);var c=a.za?jb(a.za):{};a.Da?(a.sb="POST",c["Content-Type"]="application/x-www-form-urlencoded",a.I.send(a.ta,a.sb,a.Da,c)):(a.sb="GET",a.Ac&&!ad&&(c.Connection="close"),a.I.send(a.ta,a.sb,null,c));a.b.da(1)}
g.Yd=function(a){a=a.target;var b=this.mb;b&&3==Km(a)?b.cd():this.Fc(a)};
g.Fc=function(a){try{if(a==this.I)a:{var b=Km(this.I),c=this.I.i,d=this.I.getStatus();if(K&&!ld(10)||ad&&!kd("420+")){if(4>b)break a}else if(3>b||3==b&&!Yc&&!Lm(this.I))break a;this.va||4!=b||7==c||(8==c||0>=d?this.b.da(3):this.b.da(2));Mm(this);var e=this.I.getStatus();this.Ua=e;var f=Lm(this.I);(this.ea=200==e)?(4==b&&Nm(this),this.l?(Om(this,b,f),Yc&&this.ea&&3==b&&(this.h.hb(this.f,"tick",this.Xd),this.f.start())):Pm(this,f),this.ea&&!this.va&&(4==b?this.b.jb(this):(this.ea=!1,Jm(this)))):(this.Aa=
...
g=Zm.prototype;g.Gb=null;g.U=null;g.nb=!1;g.Dc=null;g.cb=null;g.Lb=null;g.Hb=null;g.Y=null;g.oa=-1;g.Ta=null;g.Pa=null;g.connect=function(a){this.Hb=a;a=$m(this.b,null,this.Hb);Y();this.Dc=w();var b=this.b.o;null!=b?(this.Ta=b[0],(this.Pa=b[1])?(this.Y=1,an(this)):(this.Y=2,bn(this))):(xg(a,"MODE","init"),this.U=new Dm(this,0,void 0,void 0,void 0),this.U.za=this.Gb,Im(this.U,a,!1,null,!0),this.Y=0)};
function an(a){var b=$m(a.b,a.Pa,"/mail/images/cleardot.gif");zg(b);Wm(b.toString(),5E3,v(a.Zc,a),3,2E3);a.da(1)}
g.Zc=function(a){if(a)this.Y=2,bn(this);else{Y();var b=this.b;b.ca=b.ra.oa;cn(b,9)}a&&this.da(2)};
function bn(a){var b=a.b.C;if(null!=b)Y(),b?(Y(),dn(a.b,a,!1)):(Y(),dn(a.b,a,!0));else if(a.U=new Dm(a,0,void 0,void 0,void 0),a.U.za=a.Gb,b=a.b,b=$m(b,b.Ya()?a.Ta:null,a.Hb),Y(),!K||ld(10))xg(b,"TYPE","xmlhttp"),Im(a.U,b,!1,a.Ta,!1);else{xg(b,"TYPE","html");var c=a.U;a=!!a.Ta;c.Na=3;c.qa=zg(b.clone());Sm(c,a)}}
g.Bb=function(a){return this.b.Bb(a)};
g.hc=function(){return!1};
g.oc=function(a,b){this.oa=a.Ua;if(0==this.Y)if(b){try{var c=this.f.parse(b)}catch(d){c=this.b;c.ca=this.oa;cn(c,2);return}this.Ta=c[0];this.Pa=c[1]}else c=this.b,c.ca=this.oa,cn(c,2);else if(2==this.Y)if(this.nb)Y(),this.Lb=w();else if("11111"==b){if(Y(),this.nb=!0,this.cb=w(),c=this.cb-this.Dc,!K||ld(10)||500>c)this.oa=200,this.U.cancel(),Y(),dn(this.b,this,!0)}else Y(),this.cb=this.Lb=w(),this.nb=!1};
g.jb=function(){this.oa=this.U.Ua;if(this.U.ea)0==this.Y?this.Pa?(this.Y=1,an(this)):(this.Y=2,bn(this)):2==this.Y&&((!K||ld(10)?!this.nb:200>this.Lb-this.cb)?(Y(),dn(this.b,this,!1)):(Y(),dn(this.b,this,!0)));else{0==this.Y?Y():2==this.Y&&Y();var a=this.b;a.ca=this.oa;cn(a,2)}};
g.Ya=function(){return this.b.Ya()};
g.isActive=function(){return this.b.isActive()};
g.da=function(a){this.b.da(a)};function en(a){Vl.call(this);this.headers=new Kc;this.L=a||null;this.f=!1;this.K=this.b=null;this.ia=this.C="";this.i=0;this.l="";this.h=this.aa=this.o=this.W=!1;this.j=0;this.D=null;this.ja="";this.G=this.ka=!1}
...
d=Na(e.ha(),kn);c=l.FormData&&a instanceof l.FormData;!z(gn,b)||d||c||e.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");e.forEach(function(a,b){this.b.setRequestHeader(b,a)},this);
this.ja&&(this.b.responseType=this.ja);eb(this.b)&&(this.b.withCredentials=this.ka);try{ln(this),0<this.j&&(this.G=mn(this.b),rl(hn(this,"Will abort after "+this.j+"ms if incomplete, xhr2 "+this.G)),this.G?(this.b.timeout=this.j,this.b.ontimeout=v(this.gc,this)):this.D=rm(this.gc,this.j,this)),rl(hn(this,"Sending request")),this.o=!0,this.b.send(a),this.o=!1}catch(f){rl(hn(this,"Send error: "+f.message)),jn(this,f)}};
function mn(a){return K&&kd(9)&&fa(a.timeout)&&p(a.ontimeout)}
...
function hn(a,b){return b+" ["+a.ia+" "+a.C+" "+a.getStatus()+"]"}
...
function wn(a){xn(a);if(3==a.b){var b=a.Va++,c=a.eb.clone();N(c,"SID",a.g);N(c,"RID",b);N(c,"TYPE","terminate");yn(a,c);b=new Dm(a,0,a.g,b,void 0);b.Na=2;b.qa=zg(c.clone());(new Image).src=b.qa;b.Xa=w();Jm(b)}zn(a)}
...
function En(a){var b=Math.min(a.f.length,1E3),c=["count="+b],d;6<a.wa&&0<b?(d=a.f[0].b,c.push("ofs="+d)):d=0;for(var e=0;e<b;e++){var f=a.f[e].b,h=a.f[e].map,f=6>=a.wa?e:f-d;try{Rc(h,function(a,b){c.push("req"+f+"_"+b+"="+encodeURIComponent(a))})}catch(k){c.push("req"+f+"_type="+encodeURIComponent("_badmap"))}}a.h=a.h.concat(a.f.splice(0,b));
return c.join("&")}
...
g.sc=function(){this.na=null;this.F=new Dm(this,0,this.g,"rpc",this.l);this.F.za=null;this.F.Ib=0;var a=this.Yb.clone();N(a,"RID","rpc");N(a,"SID",this.g);N(a,"CI",this.rb?"0":"1");N(a,"AID",this.Ia);yn(this,a);if(!K||ld(10))N(a,"TYPE","xmlhttp"),Im(this.F,a,!0,this.fb,!1);else{N(a,"TYPE","html");var b=this.F,c=!!this.fb;b.Na=3;b.qa=zg(a.clone());Sm(b,c)}};
...
function cn(a,b){if(2==b||9==b){var c=null;a.M&&(c=null);var d=v(a.ke,a);c||(c=new jg("//www.google.com/images/cleardot.gif"),zg(c));Xm(c.toString(),1E4,d)}else Y();Jn(a,b)}
...
function $m(a,b,c){var d=Ag(c);if(""!=d.f)b&&lg(d,b+"."+d.f),mg(d,d.j);else var e=window.location,d=Bg(e.protocol,b?b+"."+e.hostname:e.hostname,e.port,c);a.Ra&&Ya(a.Ra,function(a,b){N(d,b,a)});
N(d,"VER",a.wa);yn(a,d);return d}
g.Bb=function(a){if(a)throw Error("Can't create secondary domain capable XhrIo object.");a=new en;a.ka=!1;return a};
...
g.sendMessage=function(a,b){var c={_sc:a};b&&mb(c,b);this.f.enabled||2==(this.b?this.b.b:0)?this.j.push(c):Qn(this)&&Bn(this.b,c)};
...
function Vn(a){var b={};b.index=a.index;b.listId=a.f;b.videoId=a.videoId;b.playerState=a.b;b.volume=a.volume;b.muted=a.l;b.audioTrackId=a.audioTrackId;b.trackData=kb(a.h);b.playerTime=a.g;b.playerTimeAt=a.i;return b}
...
g.w=function(){$n(this);ao(this);bo(this);I(this.o);this.o=NaN;I(this.C);this.C=NaN;this.g=null;Je(this.L);this.L.length=0;this.b.dispose();Z.A.w.call(this);this.f=this.B=this.b=null};
...
function ho(a,b){var c=b.params.videoId;delete b.params.videoId;c==a.B.videoId&&(hb(b.params)?a.B.h=null:a.B.h=b.params,a.u("remotePlayerChange"))}
...
g.vd=function(a){a.params?Xn("Received: action="+a.action+", params="+L(a.params)):Xn("Received: action="+a.action+" {}");switch(a.action){case "loungeStatus":a=od(a.params.devices);this.f=Ka(a,function(a){return new bk(a)});
...
fo(this,!1);break;case "remoteConnected":var b=new bk(od(a.params.device));Na(this.f,function(a){return a.equals(b)})||Pa(this.f,b);
...
Z.prototype.subscribe=Z.prototype.subscribe;Z.prototype.unsubscribeByKey=Z.prototype.ga;Z.prototype.ia=function(){var a=3;this.isDisposed()||(a=0,isNaN(this.j())?Qn(this.b)&&isNaN(this.h)&&(a=1):a=2);return a};
Z.prototype.getProxyState=Z.prototype.ia;Z.prototype.i=function(a){Xn("Disconnecting with "+a);$n(this);this.u("beforeDisconnect",a);1==a&&pk();On(this.b,a);this.dispose()};
...
!0,void 0);
to("Initializing: "+L(a));uo.push(mc("yt-remote-cast2-availability-change",function(){J("yt-remote-receiver-availability-change")}));
uo.push(mc("yt-remote-cast2-receiver-selected",function(){vo(null);J("yt-remote-auto-connect","cast-selector-receiver")}));
uo.push(mc("yt-remote-cast2-session-change",wo));uo.push(mc("yt-remote-connection-change",function(a){a?ql(so(),"YouTube TV"):xo()||(ql(null,null),ml())}));
var d=yo();a.isAuto&&(d.id+="#dial");d.name=a.device;d.app=a.app;to(" -- with channel params: "+L(d));zo(d);b.start();so()||Ao()}}
function Bo(){oc(uo);uo.length=0;D(Co);Co=null;po&&(y(po,function(a){a(null)}),po.length=0,po=null,q("yt.mdx.remote.deferredProxies_",null,void 0));
oo=null}
...
function Ko(){ol()?gl().stopSession():dl("stopSession called before API ready.");var a=Eo();a?a.disconnect(1):(pc("yt-remote-before-disconnect",1),pc("yt-remote-connection-change",!1));No(null)}
...
function Lo(a,b){so();Oo(a.id);var c=new Z(oo,a,yo());c.connect(b,r("yt.mdx.remote.connectData_"));c.subscribe("beforeDisconnect",function(a){pc("yt-remote-before-disconnect",a)});
...
var oo=null,po=null,Co=null;function qo(){var a=yo();if(hb(a)){var a=fk(),b=U("yt-remote-session-name")||"",c=U("yt-remote-session-app")||"",a={device:"REMOTE_CONTROL",id:a,name:b,app:c,"mdx-version":3};q("yt.mdx.remote.channelParams_",a,void 0)}}
...
function Zo(a){li()?(Q(Zh,new Th(a.externalChannelId,a.qd?{itemType:"U",itemId:a.externalChannelId}:null)),(a="/gen_204?"+Dd({event:"subscribe",source:a.source}))&&Mg(a)):$o(a)}
function $o(a){ki(function(b){b.subscription_ajax&&Zo(a)},null)}
function ap(a){a=Xo(a);Q(di,new Vh(a.externalChannelId,a.subscriptionId,null));(a="/gen_204?"+Dd({event:"unsubscribe",source:a.source}))&&Mg(a)}
...
ip.prototype.w=function(){ip.A.w.call(this);delete this.b};function jp(){var a=this.f=new Ki,b=v(this.Zd,this);a.f=b;a.g=null;this.h=[];this.l=!1;this.i={}}
...
np.prototype.w=function(){this.f=this.b=null;np.A.w.call(this)};function op(a,b,c){C.call(this);this.b=a;this.g=c;this.h=M(window,"message",v(this.i,this));this.f=new np(this,a,b);Wb(this,oa(D,this.f))}
...
op.prototype.w=function(){Je(this.h);this.b=null;op.A.w.call(this)};var pp=!1;function qp(a){if(a=a.match(/[\d]+/g))a.length=3}
...
new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6");pp=!0;return}catch(c){}try{b=new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),pp=!0,qp(b.GetVariable("$version"))}catch(c){}})();function rp(a){return(a=a.exec(nb))?a[1]:""}
(function(){if(mf)return rp(/Firefox\/([0-9.]+)/);if(K||Zc||Yc)return id;if(qf)return rp(/Chrome\/([0-9.]+)/);if(rf&&!(Xc()||A("iPad")||A("iPod")))return rp(/Version\/([0-9.]+)/);if(nf||of){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(nb);if(a)return a[1]+"."+a[2]}else if(pf)return(a=rp(/Android\s+([0-9.]+)/))?a:rp(/Version\/([0-9.]+)/);return""})();function sp(){var a={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0};return new Zl(function(b,c){a.Z=function(a){Kd(a)?b(a):c(a)};
...
;function xp(){}
;function yp(a){for(var b=0;b<a.length;b++){var c=a[b];"send_follow_on_ping_action"==c.name&&c.data&&c.data.follow_on_url&&(c=c.data.follow_on_url)&&Mg(c)}}
...
function Op(a,b,c,d){var e=new Rh(a);Q($h,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=F("PLAYBACK_ID"))&&(c.plid=d);(d=F("EVENT_ID"))&&(c.ei=d);b&&bq(b,c);Pd("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Qb:f,J:c,Z:function(b,c){var d=c.response;Q(bi,new Uh(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&J("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&yp(d.actions)},
Mb:function(){Q(ai,e)}})}
function Qp(a,b,c,d,e){var f=new Rh(a);Q(ei,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=F("PLAYBACK_ID"))&&(d.plid=a);(a=F("EVENT_ID"))&&(d.ei=a);c&&bq(c,d);Pd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Qb:h,J:d,Z:function(a,b){var c=b.response;Q(gi,f);c.actions&&yp(c.actions)},
Mb:function(){Q(fi,f)}})}
function Wp(a,b,c,d){if(null!==b||null!==c){var e={};a&&(e.channel_id=a);null===b||(e.email_on_upload=b);null===c||(e.receive_no_updates=c);Pd("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",J:e,onError:function(){d&&d()}})}}
...
Pd("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",J:c,Z:function(c,f){d();var h=f.response,k=h.id;if(da(k)&&k.length==b.length){var m=h.channel_info_map;y(k,function(a,c){var d=b[c];Q(bi,new Uh(d,a,m[d]))});
...
Pd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",J:c,Z:function(){d();aq(b,gi);a.length&&Up(a)},
onError:function(){d()}})}}
function aq(a,b){y(a,function(a){Q(b,new Rh(a))})}
function bq(a,b){var c=Gd(a),d;for(d in c)b[d]=c[d]}
;var cq,dq=null,eq=null,fq=null,gq=!1;
function hq(){var a=F("PLAYER_CONFIG",void 0),b=F("REVERSE_MOBIUS_PERCENT",void 0);if("1"!=a.privembed&&Uf&&100*Math.random()<b||$f("enable_server_side_ad_request_for_embeds"))try{var c;try{var d=r("yt.www.ads.biscotti.getId_"),e;if(d)e=d();else{if(!tp){var f=sp().then(up),h=cm(wp,wp,void 0);h.g=!0;jm(f,h);tp=f}e=tp}c=e}catch(k){c=dm(k)}em(c,null,xp,void 0)}catch(k){dc(k)}if(F("REQUEST_POST_MESSAGE_ORIGIN")){if(!cq){cq=new Ki;cq.b=hq;return}cq.origin&&"*"!=cq.origin&&(a.args.post_message_origin=cq.origin)}d=
document.referrer;b=F("POST_MESSAGE_ORIGIN");c=!1;$f("legacy_cast")&&u(d)&&u(b)&&-1<d.indexOf(b)&&Jg(b)&&Jg(d)&&(c=!0);window!=window.top&&d&&d!=document.URL&&(a.args.loaderUrl=d);F("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&ij(a.args);dq=Eh("player",a);d=F("POST_MESSAGE_ID","player");F("ENABLE_JS_API")?fq=new mp(dq):F("ENABLE_POST_API")&&u(d)&&u(b)&&(eq=new op(window.parent,d,b),fq=new ip(dq,eq.f));$f("legacy_cast")&&((gq=c&&!F("ENABLE_CAST_API"))?a.args.disableCast="1":(a=dq,
no(),Po=a,Po.addEventListener("onReady",Ro),Po.addEventListener("onRemoteReceiverSelected",To),Qo.push(mc("yt-remote-receiver-availability-change",So)),Qo.push(mc("yt-remote-auto-connect",Uo))));F("BG_P")&&(F("BG_I")||F("BG_IU"))&&Bc();Zd();Vo=dq;Vo.addEventListener("SUBSCRIBE",Yo);Vo.addEventListener("UNSUBSCRIBE",ap);Wo.push(Ug(bi,bp),Ug(gi,cp))}
...
q("writeEmbed",hq,void 0);q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a+="mac_204?action_fcts=1")&&Mg(a);return!0},void 0);
var iq=cc(function(){dh("ol");Kp=!0;Mp.push(Ug(Zh,Np),Ug(di,Pp));Kp||(Mp.push(Ug(ci,Np),Ug(hi,Pp),Ug(Wh,Rp),Ug(Xh,Tp),Ug(Yh,Vp)),Lp.push(mc("subscription-prefs",Xp)),Mp.push(Ug(Gp,Yp),Ug(Ip,$p),Ug(Fp,Zp)));sf.getInstance();var a=1<window.devicePixelRatio;if(xf(0,119)!=a){var b="f"+(Math.floor(119/31)+1),c=wf(b)||0,c=a?c|67108864:c&-67108865;0==c?delete tf[b]:(a=c.toString(16),tf[b]=a.toString());var b=[],d;for(d in tf)b.push(d+"="+escape(tf[d]));Se("PREF",b.join("&"),63072E3)}}),jq=cc(function(){var a=
dq;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();F("PL_ATT")&&(Ac=null);for(var a=0,b=Xd.length;a<b;a++){var c=Xd[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):I(c)}}Xd.length=0;a=wc("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))rc(a),b.parentNode.removeChild(b);Yd=!1;ac("DCLKSTAT",0);oc(Lp);Lp.length=0;Vg(Mp);Mp.length=0;Kp=!1;Vo&&(Vo.removeEventListener("SUBSCRIBE",Zo),Vo.removeEventListener("UNSUBSCRIBE",ap));Vo=null;Vg(Wo);Wo.length=0;
$f("legacy_cast")&&!gq&&(oc(Qo),Qo.length=0,Po&&(Po.removeEventListener("onRemoteReceiverSelected",To),Po.removeEventListener("onReady",Ro),Po=null),Bo());Xb(fq,eq);dq&&dq.destroy()});
window.addEventListener?(window.addEventListener("load",iq),window.addEventListener("unload",jq)):window.attachEvent&&(window.attachEvent("onload",iq),window.attachEvent("onunload",jq));var kq=Ei.getInstance(),lq=S(kq);lq in Ji||(kq.register(),kq.lb.push(mc("yt-uix-init-"+lq,kq.init,kq)),kq.lb.push(mc("yt-uix-dispose-"+lq,kq.dispose,kq)),Ji[lq]=kq);})();
